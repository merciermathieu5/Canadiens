...
const ATTENDU = {
  equipe: 'MONTREAL',
  taille: 24,
  echantillon: {nom: 'Steven Stamkos', salaire: 4075000, ct: 1, ov: 80},
  masseSousContrat: 53000000,
  nbSousContrat: 13,
  dateSecours: '1er août 2026',
  nbEchus: 11,
  nbBackups: 0,
  masseTotale: 93200000
};
...
(async () => {
  ...
  W.localStorage.removeItem('mtl_resignatures_v1');
  W.localStorage.removeItem('mtl_transac_v1');
